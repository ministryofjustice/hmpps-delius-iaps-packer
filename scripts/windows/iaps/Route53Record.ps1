...
try {
    ...
    #=============================================================================
    # set DNS entry for ecternaldomain - ie. stage.delius.probation.hmpps.dsd.io
    #=============================================================================
    Set-Location ENV:
    ...
    #=============================================================================
    # set DNS entry for internaldomain - ie. delius-stage.internal
    #=============================================================================
    Set-Location ENV:
    ...
    # Set Action
    if (((Get-R53ResourceRecordSet -HostedZoneId $internalHostedZone.id).ResourceRecordSets | where Name -eq $internalResourceRecordSet | measure).Count -eq 0)
    {
        $action = [Amazon.Route53.ChangeAction]::CREATE
    }
    else
    ...
    #=============================================================================
    # set DNS entry for *.probation.service.justice.gov.uk 
    #=============================================================================
    Set-Location ENV:
    ...
    # Set Action
    if (((Get-R53ResourceRecordSet -HostedZoneId $PSJGUZone.id).ResourceRecordSets | where Name -eq $resourceName | measure).Count -eq 0)
    {
        $action = [Amazon.Route53.ChangeAction]::CREATE
    }
    else
