...
Describe 'Firewall Rules' {
    ...
    Describe 'Firewall Rule Configured - Allow Inbound http 80' {
    ...
    Describe 'Firewall Rule Configured - Allow Inbound https 443' {
    ...
    Describe 'Firewall Rule Configured - Allow Inbound ALL ICMP v4' {
    ...
    Describe 'Firewall Rule Configured - Allow Inbound WinRM 5985' {
    ...
    Describe 'Firewall Rule Configured - Allow Outbound Port http 80' {
    ...
    Describe 'Firewall Rule Configured - Allow Outbound Port https 443' {
